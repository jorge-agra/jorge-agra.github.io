...
export type MessageToastItem = PreactMessageToastItem;
export type MessageToastTemplateContext<K, D> = {
    data: D;
    key: K;
    metadata?: ItemMetadata<K>;
};
export type MessageToastProps<Key = string | number, Data = MessageToastItem> = {
