 ...
 */
function findSelector(driver, by) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    webEl = _a.sent();
                    if (!!(webEl instanceof SelectorWebElement_1.SelectorWebElement)) return [3 /*break*/, 3];
                    return [4 /*yield*/, webEl.getTagName()];
                case 2:
                    tagName = _a.sent();
                    throw Error("findSelector(".concat(by, ") created ").concat(webEl.constructor.name, " for <").concat(tagName, ">, but expected ").concat(SelectorWebElement_1.SelectorWebElement.name));
